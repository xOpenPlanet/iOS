...
- (instancetype)init{
    ...
    if (self) {
        ...
        self.importWalletButton.theme_backgroundColor = [UIColor theme_colorPickerForKey:@"tipColor" fromDictName:@"login"];
        self.importWalletButton.theme_tintColor = [UIColor theme_colorPickerForKey:@"nextButtonTintColor" fromDictName:@"login"];
